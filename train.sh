...
python src/pit/pca.py -d dataset/pompa-train-v3.csv -w 5 -n 3 > logs/pit/pca-5.log
python src/pit/pca.py -d dataset/pompa-train-v3.csv -w 10 -n 3 > logs/pit/pca-10.log
python src/pit/pca.py -d dataset/pompa-train-v3.csv -w 20 -n 3 > logs/pit/pca-20.log
python src/pit/pca.py -d dataset/pompa-train-v3.csv -w 40 -n 3 > logs/pit/pca-40.log
