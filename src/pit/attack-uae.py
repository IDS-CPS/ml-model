...
for param in params:
    ...
    scaler_src = f"scaler/pit/uae-{history_size}.gz"
    model_src = f"model/pit/uae-{history_size}"
    mean_npy = f"npy/pit/uae/mean-{history_size}.npy"
    std_npy = f"npy/pit/uae/std-{history_size}.npy"
    ...
    attack_df.to_csv(f"dataset/pit/uae-{history_size}-{threshold}-{time_threshold}.csv")
