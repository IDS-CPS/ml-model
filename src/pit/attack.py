...
scaler_src = f"scaler/pit/{model}-{history_size}.gz"
model_src = f"model/pit/{model}-{history_size}"
mean_npy = f"npy/pit/{model}/mean-{history_size}.npy"
std_npy = f"npy/pit/{model}/std-{history_size}.npy"
